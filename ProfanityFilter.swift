...
//
//  Created by Adrian Bolinger on 6/15/17.
...
class ProfanityFilter: NSObject {
    ...
    /*
     ...
     yourLabel.text = profanityFilter.cleanUp(yourString)
     */
